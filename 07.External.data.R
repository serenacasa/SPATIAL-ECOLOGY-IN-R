...
library(terra)
                                                        ...
                                                        # we downloaded the image in our computer from the Earth Observatory page
                                                        ## then we have to let R access to our image. 
...
naja<- rast("najafiraq_etm_2003140_lrg.jpg")             # using function "rast" as we already used im.import()
                                                         ...
                                                         # then we have to plot the image, 
                                                         ## using a function directly from Terra called "plotRGB":
