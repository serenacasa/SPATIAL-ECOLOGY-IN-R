...
library(devtools)                                                             
# packages in R are also called libraries
...
# to use the band number of the sentinel
...
# to put every single band on top of the component on a multiframe

im.plotRGB(stacksent, r = 4, g = 3, b = 2)                                           
# red component on top of the grey one

im.plotRGB(stacksent, r = 3, g = 4, b = 2)                                           
# green component on top of the grey one

im.plotRGB(stacksent, r = 3, g = 2, b = 4)                                           
# this permits putting the blue component on top. 

# In this way, all the vegetation is going to become blue, 
# soil is going to become yellowish (this can be used to highlight cities)
