...
im.plotRGB.auto(EN01)
        im.plotRGB.auto(EN13)                               # We plot them together to confront them better
...
dif = EN01[[1]] - EN13[[1]]                                 ## difference from january and march
dev.off()
...
clg <- colorRampPalette(c("black", "blue", "white", "red")) (100)
                                                            # To make the difference more effective we can use also black
...
plot(difG, col=clG)
                                                          ...
                                                          ## we will know which one had the highest temperature comparing them 
