...
p1992                           #the count section gives us the percentage, with the forest covers the 83%, and the human the 16.91%
...
#1.1. build the columns of the dataframe, using class()
...
plot(p1) #or also only by writing p1
