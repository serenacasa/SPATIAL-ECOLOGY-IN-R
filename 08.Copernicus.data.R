...
#now we have to explain to R where the data are going to be stored:
...
ext <- c(-10,40,25,75) #minlong, maxlong, minlat, maxlat. Since here we are using numbers we do not have to use quotes

faparEU2020 <- crop(fapar2020, ext)
plot(faparEU2020[[1]], col=cl) #europe crop

ext2 <- c(110,160,-50,-05)
faparAUS2020 <- crop(fapar2020, ext2)
plot(faparAUS2020[[1]],col=cl) #australia crop
